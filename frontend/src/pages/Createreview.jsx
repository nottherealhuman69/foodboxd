    ...
    <div className={styles.page}>
      <div className={styles.header}>
        ...
        <p className={styles.sub}>
          {isMeal
            ? 'Rate the whole meal, and each dish that made it up.'
            : 'Record what you ate, rate it, and capture the moment.'}
        </p>
      </div>

      {/* 1. Type toggle — sits outside the form so the meal branch can own its own <form> */}
      <div className={styles.field}>
        <label className={styles.label}>What are you logging?</label>
        <div className={styles.toggle}>
          ...
          <button type="button"
            className={`${styles.toggleBtn} ${isMeal ? styles.toggleActive : ''}`}
            onClick={() => switchType('meal')}
          >
            <svg width="15" height="15" viewBox="0 0 20 20" fill="none">
